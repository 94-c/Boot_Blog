...
public class DummyControllerTest {
	...
	//email, password, update를 하려면 PutMapping을 받아야 한다.
	...
	public User updateUser(@PathVariable int id, @RequestBody User requestUser) { //json 데이터를 요청 => java object(Message Converter의 Jackson로 변환해서 받아줘요.
	...
	public User detail(@PathVariable int id) {
		...
		//요청 : 웹브라우저
		//user 객체 = 자바 오브젝트
		// 변환 (웹브라우저가 이해할 수 있는 데이터) -> json (Gson 라비으러리)
