...
public class UserController {
	...
	public @ResponseBody String kakaoCallback(String code) { //@ResponseBody는 Data를 리턴해주는 함수
		...
		params.add("client_id","4aba0b53045ca21c1bc18df1001d8f00");
		params.add("redirect_uri","http://localhost:8000/auth/kakao/callback");
		params.add("code",code);

		//HttpHeader와 HttpBody를 하나의 오브젝트에 담기기
		...
		//데이터를 담을 때(Gson, Json Simple, ObjectMapper)
		...
		User kakaoUser = User.builder()
				...
				.password(cosKey) //cosKey=cos1234, 절대 노출되면 안된다. 그러면 OAuth가 뚫리는거.
